...
import { attr, Forward, observable, observe, OnPropertyChanged } from '@joist/observable';
...
@styled
@observable
export class TodoCard extends Forward(HTMLElement) implements OnPropertyChanged {
  static styles = [
    css`
      :host {
        align-items: center;
